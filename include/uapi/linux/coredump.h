 ...
 * failed.
 *
 * @COREDUMP_MARK_INVALIDSIZE: the provided coredump_ack size was invalid
...
enum coredump_mark {
	...
	COREDUMP_MARK_INVALIDSIZE	= 1U,
	COREDUMP_MARK_UNSUPPORTED	= 2U,
	COREDUMP_MARK_CONFLICTING	= 3U,
